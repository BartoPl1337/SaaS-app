        ...
        <Card className="w-full sm:max-w-md">
            <CardContent className="flex flex-col gap-4">
                ...
                <Field orientation="horizontal">
                    <Button type="submit" form="bug-report-form" className="w-full h-14 font-bold text-base">
                        Zarejestruj się
                    </Button>
                </Field>
            </CardContent>
            <CardFooter className="flex justify-center mx-4 bg-white">
                <h3>
                    Masz już konto? <Link href="/signIn" className="text-orange-500 font-semibold">Zaloguj się</Link>
                </h3>
            </CardFooter>
        </Card>
    )
